...
const buildSystemPrompt = () => [
  ...
  "    For every event, show startLocal/endLocal instead of raw start/end.",
  "    For allDay:true, endLocal is exclusive: an event from June 18 to June 19",
  "    means June 18 all day, not a two-day event.",
